...
library FeeManager {
        ...
        returns (uint256 fee)
    {
        ...
        uint256 num = liquidityMinFee * liquidityFeeK / liquidityMaxFee * (ratioDecimals + relPriceDiff1Sq)
            / ratioDecimals + relPriceDiff2Sq * liquidityFeeDecimals / ratioDecimals;
        uint256 den = liquidityFeeK * (ratioDecimals + relPriceDiff1Sq) / ratioDecimals + relPriceDiff2Sq
            * liquidityFeeDecimals / ratioDecimals;
        ...
        returns (uint256 fee)
    {
        ...
        if (
            (initialStableLiquidity - stableLiquidity) < 10e18
                && (initialAssetLiquidity - assetLiquidity) < 10e18 * oracleDecimals / price
        ) {
            return 0;
        }
        uint256 p;
