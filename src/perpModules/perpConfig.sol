...
abstract contract PerpConfig is PerpStorage, AccessControl, ERC2771Context {
        ...
        onlyRole(MOD_ROLE)
    {
        ...
        paramHash = keccak256(
            abi.encode(
                keccak256(abi.encodePacked(_MMR, _tradingFee, _flatTradingFee, _feeLP)),
                _liquidityMinFee,
                _liquidityMaxFee,
                _liquidityFeeK,
                _fundingC,
        ...
        onlyRole(MOD_ROLE)
    {
        ...
        emit ParametersUpdated(
            _oracle, _feeFrontend, _feeProtocolAddr, _insuranceFundCap, _maxLeverage, _liquidationDiscount
        );
    }
