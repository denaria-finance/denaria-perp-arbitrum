...
abstract contract PerpLiquidation is PerpAutoClose {
        ...
        nonReentrant
    {
        ...
        uint256 fraction = liquidatedPositionSize * decimals.liquidationDecimals
        ...
        require(
            UtilMath.calcMR(_msgSender(), spotPrice, address(this), getCollateral(_msgSender()), lastOperationTimestamp)
                > MMR,
            "LQ2"
        ...
        emit LiquidatedUser(
            ...
            _msgSender(),
            fraction,
            (liquidatedPositionSize * spotPrice / oracleDecimals) * discount / decimals.liquidationDecimals,
            (liquidatedPositionSize * spotPrice / oracleDecimals),
            spotPrice,
            liquidationPnL,
            expositionSide
        );
    ...
    function _liquidatePosition(uint256 dAmount, address user, uint256 discount, bool direction) private {
        ...
        if (direction) {
            ...
            uint256 dyPrime = _computeShortReturn(
                dAmount,
                price,
                oracleDecimals,
            ...
            if (liquidatorPosition.balanceStable >= dy) {
                ...
                liquidatorPosition.debtStable += dy - liquidatorPosition.balanceStable;
            ...
            if (liquidatorPosition.balanceAsset >= dAmount) {
                ...
                liquidatorPosition.debtAsset += dAmount - liquidatorPosition.balanceAsset;
