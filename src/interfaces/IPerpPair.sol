...
interface IPerpPair {
    ...
    function closeTrade(
        ...
        external;
    function computeFundingFee(address user) external view returns (uint256 localFundingFee, bool localFundingFeeSign);
    ...
    function curveMathAdapter() external view returns (address);
